...
import 'weekendin_moscow2_model.dart';
export 'weekendin_moscow2_model.dart';

class WeekendinMoscow2Widget extends StatefulWidget {
  const WeekendinMoscow2Widget({super.key});

  static String routeName = 'WeekendinMoscow2';
  static String routePath = 'weekendinMoscow2';

  @override
  State<WeekendinMoscow2Widget> createState() => _WeekendinMoscow2WidgetState();
}

class _WeekendinMoscow2WidgetState extends State<WeekendinMoscow2Widget> {
  late WeekendinMoscow2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WeekendinMoscow2Model());
