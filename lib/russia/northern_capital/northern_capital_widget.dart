...
import 'northern_capital_model.dart';
export 'northern_capital_model.dart';

class NorthernCapitalWidget extends StatefulWidget {
  const NorthernCapitalWidget({super.key});

  static String routeName = 'NorthernCapital';
  static String routePath = 'northernCapital';

  @override
  State<NorthernCapitalWidget> createState() => _NorthernCapitalWidgetState();
}

class _NorthernCapitalWidgetState extends State<NorthernCapitalWidget> {
  late NorthernCapitalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NorthernCapitalModel());
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Day 4. Departure from Saint-Petersburg',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inriaSerif(
