...
import 'two_capitalslight_model.dart';
export 'two_capitalslight_model.dart';

class TwoCapitalslightWidget extends StatefulWidget {
  const TwoCapitalslightWidget({super.key});

  static String routeName = 'TwoCapitalslight';
  static String routePath = 'twoCapitalslight';

  @override
  State<TwoCapitalslightWidget> createState() => _TwoCapitalslightWidgetState();
}

class _TwoCapitalslightWidgetState extends State<TwoCapitalslightWidget> {
  late TwoCapitalslightModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TwoCapitalslightModel());
                              ...
                              children: [
                                      ...
                                      RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            ...
                                            TextSpan(
                                              text:
                                                  '\n\nOptional Excursion to Peterhoff Park (approx. 4 hours) – cost US\$ 80 per pax',
                                              style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                              ),
                                            ),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Day 7. Departure from Saint-Petersburg',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inriaSerif(
