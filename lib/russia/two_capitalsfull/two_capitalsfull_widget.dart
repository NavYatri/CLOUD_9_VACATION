...
import 'two_capitalsfull_model.dart';
export 'two_capitalsfull_model.dart';

class TwoCapitalsfullWidget extends StatefulWidget {
  const TwoCapitalsfullWidget({super.key});

  static String routeName = 'TwoCapitalsfull';
  static String routePath = 'twoCapitalsfull';

  @override
  State<TwoCapitalsfullWidget> createState() => _TwoCapitalsfullWidgetState();
}

class _TwoCapitalsfullWidgetState extends State<TwoCapitalsfullWidget> {
  late TwoCapitalsfullModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TwoCapitalsfullModel());
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      'Day 4.  Moscow – Saint Petersburg (by rapid train).',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inriaSerif(
                                    ...
                                    RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text:
                                                'Breakfast in the hotel at 09.00.\nDay time transfer to the railway station to get on board of rapid train to proceed to Saint-Petersburg. Meeting with the representative of the company who assist you for transfer and hotel check inn. Check inn time and relax. Overnight at the hotel.',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inriaSerif(
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Day 7.  Saint-Petersburg. Visit of Peterhoff and Tsarskoe Selo (120 km – 2 hours drive total)',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inriaSerif(
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Day 8.  Departure from Saint-Petersburg',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inriaSerif(
