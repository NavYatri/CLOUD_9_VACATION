...
import 'northern_capitalwith_peterhoff_tsar_village_model.dart';
export 'northern_capitalwith_peterhoff_tsar_village_model.dart';

class NorthernCapitalwithPeterhoffTsarVillageWidget extends StatefulWidget {
  const NorthernCapitalwithPeterhoffTsarVillageWidget({super.key});

  static String routeName = 'NorthernCapitalwithPeterhoffTsarVillage';
  static String routePath = 'northernCapitalwithPeterhoffTsarVillage';

  @override
  State<NorthernCapitalwithPeterhoffTsarVillageWidget> createState() =>
      _NorthernCapitalwithPeterhoffTsarVillageWidgetState();
}

class _NorthernCapitalwithPeterhoffTsarVillageWidgetState
    extends State<NorthernCapitalwithPeterhoffTsarVillageWidget> {
  late NorthernCapitalwithPeterhoffTsarVillageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(
        context, () => NorthernCapitalwithPeterhoffTsarVillageModel());
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          'Day 4.  Saint-Petersburg. Visit of Peterhoff and Tsarskoe Selo (120 km – 2 hours drive in total)',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.inriaSerif(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          'Day 5.  Departure from Saint-Petersburg',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.inriaSerif(
