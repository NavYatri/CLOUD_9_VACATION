...
import 'two_capitalsand_golden_ring_model.dart';
export 'two_capitalsand_golden_ring_model.dart';

class TwoCapitalsandGoldenRingWidget extends StatefulWidget {
  const TwoCapitalsandGoldenRingWidget({super.key});

  static String routeName = 'TwoCapitalsandGoldenRing';
  static String routePath = 'twoCapitalsandGoldenRing';

  @override
  State<TwoCapitalsandGoldenRingWidget> createState() =>
      _TwoCapitalsandGoldenRingWidgetState();
}

class _TwoCapitalsandGoldenRingWidgetState
    extends State<TwoCapitalsandGoldenRingWidget> {
  late TwoCapitalsandGoldenRingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TwoCapitalsandGoldenRingModel());
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Day 1. Arrival to Saint-Petersburg (International flight).',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inriaSerif(
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      'Day 4. Thursday. Saint-Petersburg. Visit of Peterhoff and Tsarskoe Selo (120 km – 2 hours drive in total)',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inriaSerif(
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Day 5.  Saint Petersburg – Moscow (by rapid train).',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inriaSerif(
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Day 8.  Moscow – Vladimir – Suzdal (230 km – 4 hours drive)',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inriaSerif(
                                      ...
                                      RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            ...
                                            TextSpan(
                                              text:
                                                  'this cathedral used to be the main Russian cathedral more than 100 years. Many of the Russian monarchs were crowned there. The Assumption Cathedral in Vladimir was the pattern for the Assumption Cathedral in Moscow.\n\n',
                                              style: TextStyle(),
                                            ),
                                            TextSpan(
                                              text:
                                            ...
                                            TextSpan(
                                              text:
                                                  'it is decorated with more than 500 white-stone carved reliefs.\nWe will also walk along the main and the most beautiful street in Vladimir Bolshaya Moskovskaya. We will visit Saint George’s church which was founded by Yuri the I Dolgorukiy.\nTransfer to Suzdal.\n\n\nThe city of Suzdal is first mentioned in The Chronicles of 1024. Very soon the city became the religious center of the first rank that had numerous monasteries and churches. Today the city is an important tourist center with many examples of ancient Russian architecture. You will visit:\n',
                                              style: TextStyle(),
                                            ),
                                            TextSpan(
                                              text:
                                            ...
                                            TextSpan(
                                              text:
                                                  ' it is the historical center of the city. The merchant’s wooden house it is about 200 years old, the ancient carved wooden gate of the 19th century, various churches in the Kremlin and the Nativity of the Virgin Cathedral.\nThe Market Square - it is the trading place with the more than 800 years history. It is the place where some of the famous Russian movies were shot.\n\n',
                                              style: TextStyle(),
                                            ),
                                            TextSpan(
                                              text:
                                                  'The Convent of the Deposition of the Virgin’s Robe - ',
                                              style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                              ),
                                            ),
                                            TextSpan(
                                              text:
                                                  'this is the oldest convent in Suzdal, it was founded in the 13th century. Here you can climb up the stairs of the Prepodobenskaya bell tower. It is the highest sightseeing place in Suzdal, here you can observe the city from the 131 feet high point (40 meters).',
                                              style: TextStyle(),
                                            ),
                                            TextSpan(
                                              text:
                                            ...
                                            TextSpan(
                                              text:
                                                  'this convent was founded in the 14th century. This convent was the place of imprisonment of the tsars’ and emperors’ wives. Vasil III, Ivan the Terrible and Peter the Great and many other famous people sent their wives to this cloister.\n\n',
                                              style: TextStyle(),
                                            ),
                                            TextSpan(
                                              text:
                                                  'Yuri the I Dolgorukiy Residence in the Village Kideksha –',
                                              style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                              ),
                                            ),
                                            TextSpan(
                                              text:
                                                  'there you will see the oldest white stone cathedral in the central part of Russia. This cathedral was founded in 1152. It is included in UNESCO World Heritage List.\nOvernight at the hotel.',
                                              style: TextStyle(),
                                            )
                                          ],
                                          style: FlutterFlowTheme.of(context)
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Day 9.  Suzdal – Rostov – Sergiyev Posad (300 km – 4.5 hours)',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inriaSerif(
