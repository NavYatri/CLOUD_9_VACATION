...
import 'moscowand_golden_ring_model.dart';
export 'moscowand_golden_ring_model.dart';

class MoscowandGoldenRingWidget extends StatefulWidget {
  const MoscowandGoldenRingWidget({super.key});

  static String routeName = 'MoscowandGoldenRing';
  static String routePath = 'moscowandGoldenRing';

  @override
  State<MoscowandGoldenRingWidget> createState() =>
      _MoscowandGoldenRingWidgetState();
}

class _MoscowandGoldenRingWidgetState extends State<MoscowandGoldenRingWidget> {
  late MoscowandGoldenRingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MoscowandGoldenRingModel());
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Fix dates arrivals (Friday arrivals to Moscow):',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inriaSerif(
                                    ...
                                    Text(
                                      'Moscow (3) – Suzdal (1) – Sergiyev Posad (1)',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inriaSerif(
                                      ...
                                      RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text:
                                                  'Arrival to one of the international airports of Moscow city, passing immigration, collecting luggage, and welcoming by our representative who assist you for transfer and hotel check inn. City’s brief introduction on the way to the hotel, check Inn time and relax. Overnight at the hotel.',
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      'Day 4. Moscow – Vladimir – Suzdal (230 km – 4 hours drive)',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inriaSerif(
                                    ...
                                    RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          ...
                                          TextSpan(
                                            text: 'the symbol of Vladimir\n\n',
                                            style: TextStyle(),
                                          ),
                                          TextSpan(
                                            text: 'The Assumption Cathedral –',
                                            style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                            ),
                                          ),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Day 5.  Suzdal – Rostov – Sergiyev Posad (300 km – 4.5 hours)',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inriaSerif(
