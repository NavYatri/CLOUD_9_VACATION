...
import 'cavesof_mizoram_model.dart';
export 'cavesof_mizoram_model.dart';

class CavesofMizoramWidget extends StatefulWidget {
  const CavesofMizoramWidget({super.key});

  static String routeName = 'CavesofMizoram';
  static String routePath = 'cavesofMizoram';

  @override
  State<CavesofMizoramWidget> createState() => _CavesofMizoramWidgetState();
}

class _CavesofMizoramWidgetState extends State<CavesofMizoramWidget> {
  late CavesofMizoramModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CavesofMizoramModel());
