...
import 'honeymoon_tour_packages_model.dart';
export 'honeymoon_tour_packages_model.dart';

class HoneymoonTourPackagesWidget extends StatefulWidget {
  const HoneymoonTourPackagesWidget({super.key});

  static String routeName = 'HoneymoonTourPackages';
  static String routePath = '/honeymoonTourPackages';

  @override
  State<HoneymoonTourPackagesWidget> createState() =>
      _HoneymoonTourPackagesWidgetState();
}

class _HoneymoonTourPackagesWidgetState
    extends State<HoneymoonTourPackagesWidget> {
  late HoneymoonTourPackagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HoneymoonTourPackagesModel());
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  context.pushNamed(
                                                      TheTreasuresofIndiaandNepalWidget
                                                          .routeName);
                                                },
                                                text: 'View details',
                                                options: FFButtonOptions(
