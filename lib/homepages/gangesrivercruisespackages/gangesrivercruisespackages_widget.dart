...
import 'gangesrivercruisespackages_model.dart';
export 'gangesrivercruisespackages_model.dart';

class GangesrivercruisespackagesWidget extends StatefulWidget {
  const GangesrivercruisespackagesWidget({super.key});

  static String routeName = 'GANGESRIVERCRUISESPACKAGES';
  static String routePath = '/gangesrivercruisespackages';

  @override
  State<GangesrivercruisespackagesWidget> createState() =>
      _GangesrivercruisespackagesWidgetState();
}

class _GangesrivercruisespackagesWidgetState
    extends State<GangesrivercruisespackagesWidget> {
  late GangesrivercruisespackagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GangesrivercruisespackagesModel());
                                            ...
                                            children: [
                                              Align(
                                                alignment: AlignmentDirectional(
                                                    0.0, 0.0),
                                                child: Text(
                                                  'The Historic Hooghly (Lower Ganges)',
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  context.pushNamed(
                                                      TheHistoricHooghlyLowerGangesWidget
                                                          .routeName);
                                                },
                                                text: 'View details',
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  context.pushNamed(
                                                      TheHistoricHooghlyLowerGanges2Widget
                                                          .routeName);
                                                },
                                                text: 'View details',
                                                options: FFButtonOptions(
                                            ...
                                            children: [
                                              Align(
                                                alignment: AlignmentDirectional(
                                                    0.0, 0.0),
                                                child: Text(
                                                  'City of Light - A Varanasi Summer',
                                                  textAlign: TextAlign.center,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  context.pushNamed(
                                                      CityofLightAVaranasiSummerWidget
                                                          .routeName);
                                                },
                                                text: 'View details',
                                                options: FFButtonOptions(
