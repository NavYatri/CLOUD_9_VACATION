...
import 'trekking_tour_packages_model.dart';
export 'trekking_tour_packages_model.dart';

class TrekkingTourPackagesWidget extends StatefulWidget {
  const TrekkingTourPackagesWidget({super.key});

  static String routeName = 'TrekkingTourPackages';
  static String routePath = '/trekkingTourPackages';

  @override
  State<TrekkingTourPackagesWidget> createState() =>
      _TrekkingTourPackagesWidgetState();
}

class _TrekkingTourPackagesWidgetState
    extends State<TrekkingTourPackagesWidget> {
  late TrekkingTourPackagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrekkingTourPackagesModel());
