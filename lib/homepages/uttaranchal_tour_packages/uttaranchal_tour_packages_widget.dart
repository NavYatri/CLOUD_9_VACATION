...
class UttaranchalTourPackagesWidget extends StatefulWidget {
  const UttaranchalTourPackagesWidget({super.key});

  static String routeName = 'UttaranchalTourPackages';
  static String routePath = '/uttaranchalTourPackages';

  @override
  State<UttaranchalTourPackagesWidget> createState() =>
      _UttaranchalTourPackagesWidgetState();
}

class _UttaranchalTourPackagesWidgetState
    extends State<UttaranchalTourPackagesWidget> {
  late UttaranchalTourPackagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UttaranchalTourPackagesModel());
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Delhi - Kathgodam - Song - Dhakuri - Khati - Dwali - Phurkiya - Nainital - Delhi',
                                                textAlign: TextAlign.center,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                        ...
                                        Stack(
                                          children: [
                                            ClipRRect(
                                              ...
                                              child: Image.network(
                                                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQImdXa_0fTDz3pEJUjjGDMXLrr7o9vr6rfRg&s',
                                                width: double.infinity,
                                                height: 270.0,
                                                fit: BoxFit.cover,
                                              ),
