...
import 'cultural_tour_packages_india_model.dart';
export 'cultural_tour_packages_india_model.dart';

class CulturalTourPackagesIndiaWidget extends StatefulWidget {
  const CulturalTourPackagesIndiaWidget({super.key});

  static String routeName = 'CulturalTourPackagesIndia';
  static String routePath = '/culturalTourPackagesIndia';

  @override
  State<CulturalTourPackagesIndiaWidget> createState() =>
      _CulturalTourPackagesIndiaWidgetState();
}

class _CulturalTourPackagesIndiaWidgetState
    extends State<CulturalTourPackagesIndiaWidget> {
  late CulturalTourPackagesIndiaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CulturalTourPackagesIndiaModel());
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Delhi - Agra - Gwalior - Orchha - Bhopal - Indore - Mandu - Maheshwar - Omkareshwar - Aurangabad - Mumbai',
                                                textAlign: TextAlign.center,
                                                style:
                                        ...
                                        Stack(
                                          children: [
                                            ClipRRect(
                                              ...
                                              child: Image.network(
                                                'https://as2.ftcdn.net/jpg/10/99/72/59/1000_F_1099725916_wQyMLWkFjbJqd25Rl7kpg90OeeBh5d3r.jpg',
                                                width: double.infinity,
                                                height: 270.0,
                                                fit: BoxFit.cover,
                                              ),
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Mumbai - Aurangabad - Ellora Caves - Ajanta Caves - Aurangabad - Hyderabad - Gulbarga - Bijapur - Badami - Hampi - Hospet - Mumbai',
                                                textAlign: TextAlign.center,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                        ...
                                        Stack(
                                          children: [
                                            ClipRRect(
                                              ...
                                              child: Image.network(
                                                'https://as1.ftcdn.net/jpg/09/28/40/28/1000_F_928402818_TWNrrIyuSyQG7mtYMsDUtKRqpoVlDzEv.jpg',
                                                width: double.infinity,
                                                height: 270.0,
                                                fit: BoxFit.cover,
                                              ),
                                        ...
                                        Stack(
                                          children: [
                                            ClipRRect(
                                              ...
                                              child: Image.network(
                                                'https://as2.ftcdn.net/jpg/07/88/42/43/1000_F_788424376_zJF487IDhcAPITwhg00FSxVpJ1TVD2Oo.jpg',
                                                width: double.infinity,
                                                height: 270.0,
                                                fit: BoxFit.cover,
                                              ),
