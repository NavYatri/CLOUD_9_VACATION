...
import 'south_india_tour_packages_model.dart';
export 'south_india_tour_packages_model.dart';

class SouthIndiaTourPackagesWidget extends StatefulWidget {
  const SouthIndiaTourPackagesWidget({super.key});

  static String routeName = 'SouthIndiaTourPackages';
  static String routePath = '/southIndiaTourPackages';

  @override
  State<SouthIndiaTourPackagesWidget> createState() =>
      _SouthIndiaTourPackagesWidgetState();
}

class _SouthIndiaTourPackagesWidgetState
    extends State<SouthIndiaTourPackagesWidget> {
  late SouthIndiaTourPackagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SouthIndiaTourPackagesModel());
                                            ...
                                            children: [
                                              Align(
                                                alignment: AlignmentDirectional(
                                                    0.0, 0.0),
                                                child: Text(
                                                  'Houseboat Experience in Backwaters of Kerala',
                                                  textAlign: TextAlign.center,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                              ...
                                              Text(
                                                'Cochin - Alleppey - Kumarakom - Cochin',
                                                textAlign: TextAlign.center,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                            ...
                                            children: [
                                              Align(
                                                alignment: AlignmentDirectional(
                                                    0.0, 0.0),
                                                child: Text(
                                                  'Culinary Tour Of God\'s Own Country',
                                                  textAlign: TextAlign.center,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                              ...
                                              Text(
                                                'Cochin - Kumarakom - Thekkady - Cochin',
                                                textAlign: TextAlign.center,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                        ...
                                        Stack(
                                          children: [
                                            ClipRRect(
                                              ...
                                              child: Image.network(
                                                'https://as1.ftcdn.net/jpg/06/85/29/18/1000_F_685291819_fBfAh8JR7ZtGnrbCZQ1VsmptLOn8Cgu0.jpg',
                                                width: double.infinity,
                                                height: 270.0,
                                                fit: BoxFit.cover,
                                              ),
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Chennai - Mahabalipuram - Kanchipuram - Mahabalipuram - Tanjore - Trichy - Madurai - Thekkady - Cochin - Guruvayur - Mysore - Bangalore - Mumbai - Udaipur - Jaipur - Agra - Khajuraho - Varanasi - Delhi',
                                                textAlign: TextAlign.center,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                        ...
                                        Stack(
                                          children: [
                                            ClipRRect(
                                              ...
                                              child: Image.network(
                                                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhCoTCkVJ64fQSdPltNdNYeBLEJz-jEeZ1MQ&s',
                                                width: double.infinity,
                                                height: 270.0,
                                                fit: BoxFit.cover,
                                              ),
                                        ...
                                        Stack(
                                          children: [
                                            ClipRRect(
                                              ...
                                              child: Image.network(
                                                'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4KS-XhoGgDveeI2Ep1HSQnPDsV5jz_bPm5Q&s',
                                                width: double.infinity,
                                                height: 270.0,
                                                fit: BoxFit.cover,
                                              ),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  context.pushNamed(
                                                      WildlifetourofSouthIndiaWidget
                                                          .routeName);
                                                },
                                                text: 'View details',
                                                options: FFButtonOptions(
                                        ...
                                        Stack(
                                          children: [
                                            ClipRRect(
                                              ...
                                              child: Image.network(
                                                'https://3.imimg.com/data3/GP/GG/MY-5636507/temple-and-spices-tour-package-500x500.jpg',
                                                width: double.infinity,
                                                height: 270.0,
                                                fit: BoxFit.cover,
                                              ),
