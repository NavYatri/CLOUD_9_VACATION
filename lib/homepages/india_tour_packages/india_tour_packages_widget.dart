...
import 'india_tour_packages_model.dart';
export 'india_tour_packages_model.dart';

class IndiaTourPackagesWidget extends StatefulWidget {
  ...
  State<IndiaTourPackagesWidget> createState() =>
      _IndiaTourPackagesWidgetState();
}

class _IndiaTourPackagesWidgetState extends State<IndiaTourPackagesWidget> {
  late IndiaTourPackagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IndiaTourPackagesModel());
                                    ...
                                    Stack(
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGvr1HxCJdDFYDYvRU3VpFGDelNKgDSKjURBzQn7MWaLKNaQ4clcsoH9hPJxnzt7ltf0A&usqp=CAU',
                                            width: double.infinity,
                                            height: 270.0,
                                            fit: BoxFit.cover,
                                          ),
                                    ...
                                    Stack(
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            'https://as2.ftcdn.net/jpg/08/89/64/55/1000_F_889645570_lvLJKOOLyivqoULXBXM4Zs081VsWHowX.jpg',
                                            width: double.infinity,
                                            height: 270.0,
                                            fit: BoxFit.cover,
                                          ),
                                    ...
                                    Stack(
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            'https://as1.ftcdn.net/jpg/03/14/63/28/1000_F_314632891_XdVJMdIPnr32Y3sspzTk76dfn1ZAgFB3.jpg',
                                            width: double.infinity,
                                            height: 270.0,
                                            fit: BoxFit.cover,
                                          ),
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'Delhi - Srinagar - Gulmarg - Pahalgam - Sonmarg - Srinagar - Delhi',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                    ...
                                    Stack(
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            'https://t3.ftcdn.net/jpg/02/93/48/90/240_F_293489043_pJZ1AfJK4sVdmisbgAxSoyQ5nOosyWre.jpg',
                                            width: double.infinity,
                                            height: 270.0,
                                            fit: BoxFit.cover,
                                          ),
                                        ...
                                        children: [
                                          Align(
                                            alignment:
                                                AlignmentDirectional(0.0, 0.0),
                                            child: Text(
                                              'Chandratal Trekking Tour India',
                                              textAlign: TextAlign.center,
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                          ...
                                          Text(
                                            'Delhi - Manali - Batal - Chandratal - Tokpo Gongma - Baralacha - Delhi',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
