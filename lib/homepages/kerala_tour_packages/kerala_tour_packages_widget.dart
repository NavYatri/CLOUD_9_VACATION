...
import 'kerala_tour_packages_model.dart';
export 'kerala_tour_packages_model.dart';

class KeralaTourPackagesWidget extends StatefulWidget {
  const KeralaTourPackagesWidget({super.key});

  static String routeName = 'KeralaTourPackages';
  static String routePath = '/keralaTourPackages';

  @override
  State<KeralaTourPackagesWidget> createState() =>
      _KeralaTourPackagesWidgetState();
}

class _KeralaTourPackagesWidgetState extends State<KeralaTourPackagesWidget> {
  late KeralaTourPackagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KeralaTourPackagesModel());
                                            ...
                                            children: [
                                              Align(
                                                alignment: AlignmentDirectional(
                                                    0.0, 0.0),
                                                child: Text(
                                                  'House Boat Experience in Backwaters of Kerala',
                                                  textAlign: TextAlign.center,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
