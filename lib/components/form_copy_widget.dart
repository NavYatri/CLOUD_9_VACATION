...
class FormCopyWidget extends StatefulWidget {
  const FormCopyWidget({super.key});

  @override
  State<FormCopyWidget> createState() => _FormCopyWidgetState();
}
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      _model.apiResult248 = await EmailCall.call(
                        ...
                        res: _model.dropDownValue,
                        phone: _model.textController3.text,
                        arr: _model.textController4.text,
                        dur: _model.textController5.text,
                        adults: _model.textController6.text,
                        child: _model.textController7.text,
                        dest: _model.textController8.text,
                      );
