...
import 'form_copy2_model.dart';
export 'form_copy2_model.dart';

class FormCopy2Widget extends StatefulWidget {
  const FormCopy2Widget({super.key});

  @override
  State<FormCopy2Widget> createState() => _FormCopy2WidgetState();
}

class _FormCopy2WidgetState extends State<FormCopy2Widget> {
  late FormCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormCopy2Model());
