...
import 'pushkar_fair_tour_model.dart';
export 'pushkar_fair_tour_model.dart';

class PushkarFairTourWidget extends StatefulWidget {
  const PushkarFairTourWidget({super.key});

  static String routeName = 'PushkarFairTour';
  static String routePath = '/pushkarFairTour';

  @override
  State<PushkarFairTourWidget> createState() => _PushkarFairTourWidgetState();
}

class _PushkarFairTourWidgetState extends State<PushkarFairTourWidget> {
  late PushkarFairTourModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PushkarFairTourModel());
