...
import 'mesmerizing_sri_lanka_model.dart';
export 'mesmerizing_sri_lanka_model.dart';

class MesmerizingSriLankaWidget extends StatefulWidget {
  const MesmerizingSriLankaWidget({super.key});

  static String routeName = 'MesmerizingSriLanka';
  static String routePath = 'mesmerizingSriLanka';

  @override
  State<MesmerizingSriLankaWidget> createState() =>
      _MesmerizingSriLankaWidgetState();
}

class _MesmerizingSriLankaWidgetState extends State<MesmerizingSriLankaWidget> {
  late MesmerizingSriLankaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MesmerizingSriLankaModel());
                                      ...
                                      RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text:
                                                  'Arrival and welcome at the airport. Transfer you to your hotel in Colombo or in Negombo. Check-in to the hotel & relax.  \nDinner and overnight stay at the hotel.',
                                      ...
                                      RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text:
                                                  'Breakfast at the Hotel. Transfer to your beach destination (Program includes beach destinations from Negombo to Weligama).  \nRest of the day at leisure.  \nDinner and overnight stay at the hotel.',
                                              style: TextStyle(),
                                            )
                                          ],
                                          style: FlutterFlowTheme.of(context)
