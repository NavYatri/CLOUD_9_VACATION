...
import 'bestof_almaty_model.dart';
export 'bestof_almaty_model.dart';

class BestofAlmatyWidget extends StatefulWidget {
  const BestofAlmatyWidget({super.key});

  static String routeName = 'BestofAlmaty';
  static String routePath = 'bestofAlmaty';

  @override
  State<BestofAlmatyWidget> createState() => _BestofAlmatyWidgetState();
}

class _BestofAlmatyWidgetState extends State<BestofAlmatyWidget> {
  late BestofAlmatyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BestofAlmatyModel());
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Day 3 - Almaty: Meadows & Shymbulak Tour  ',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inriaSerif(
                                      ...
                                      RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text:
                                                  'Breakfast from 07:00-10:00 hrs  \nTransfer for excursion at 10:30 hrs  \nVisit the Meadow Gorge and Shymbulak ski resort, located at an altitude of 2230 meters. Enjoy the stunning mountain views, mild climate, and snow-capped peaks. The cable car fee is included.  \nLunch at an Indian restaurant  \nReturn to the hotel  \n19:00 hrs: Gala dinner at an Indian restaurant, with snacks, local vodka, beer, soft drinks, and a belly dance performance  \nReturn to the hotel  \nFree time to explore night activities  \nOvernight at the hotel  ',
                                              style: TextStyle(),
                                            )
                                          ],
                                          style: FlutterFlowTheme.of(context)
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      'Day 4 - Almaty: Visit to Gorky Park & Kok-Tobe Tour  ',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inriaSerif(
                                    ...
                                    RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text:
                                                'Breakfast from 07:00-10:00 hrs  \nVisit Gorky Park, a popular recreational area in the heart of Almaty, with walking paths, playgrounds, cafes, and more. In winter, the park offers ice skating and seasonal activities.  \nLunch at an Indian restaurant  \nVisit Kok-Tobe, the highest point in Almaty. Explore the recreation area with amusement park attractions and restaurants. The 372-meter TV tower at the foot of the mountain is a city landmark.  \n19:00 hrs: Dinner at an Indian restaurant  \nFree time to explore nightlife  \nOvernight at the hotel  ',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inriaSerif(
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Day 5 - Shopping Tour & Goodbye Almaty  ',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.inriaSerif(
