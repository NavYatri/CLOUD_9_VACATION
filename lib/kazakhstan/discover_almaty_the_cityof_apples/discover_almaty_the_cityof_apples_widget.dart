...
import 'discover_almaty_the_cityof_apples_model.dart';
export 'discover_almaty_the_cityof_apples_model.dart';

class DiscoverAlmatyTheCityofApplesWidget extends StatefulWidget {
  const DiscoverAlmatyTheCityofApplesWidget({super.key});

  static String routeName = 'DiscoverAlmaty-TheCityofApples';
  static String routePath = 'discoverAlmatyTheCityofApples';

  @override
  State<DiscoverAlmatyTheCityofApplesWidget> createState() =>
      _DiscoverAlmatyTheCityofApplesWidgetState();
}

class _DiscoverAlmatyTheCityofApplesWidgetState
    extends State<DiscoverAlmatyTheCityofApplesWidget> {
  late DiscoverAlmatyTheCityofApplesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DiscoverAlmatyTheCityofApplesModel());
                                    ...
                                    RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text:
                                                'Breakfast from 07:00-10:00 hrs  \nFull Day Tour: Almaty Shopping tour, Green Bazaar and Rakhat Chocolate Shop with Private Transfers\nOvernight at the hotel  ',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inriaSerif(
